    ...
    >
      <div className="flex overflow-hidden h-[70vh]">
        ...
        <div className="w-1/3 border-r border-white/5 pr-8 space-y-8 overflow-y-auto">
          ...
          <div className="aspect-square w-full bg-white/5 rounded-2xl flex flex-col items-center justify-center border-2 border-dashed border-white/5 group transition-colors hover:border-white/10 overflow-hidden relative text-white">
            {coverUrl ? (
